...
Built AI-first: I direct AI coding tools to generate and refactor the code while I own the architecture, the tool boundaries, and the failure modes, then read, run, and debug what ships. Twenty-five years building software is what tells me where a system like this rots and what "runs unattended" actually costs.
